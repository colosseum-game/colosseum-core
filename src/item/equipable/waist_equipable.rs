...
impl<'a> From<WaistEquipableIdentifier> for &WaistEquipable<'a> {
    fn from(identifier: WaistEquipableIdentifier) -> Self {
        match identifier {
...
pub enum WaistEquipableIdentifier {
