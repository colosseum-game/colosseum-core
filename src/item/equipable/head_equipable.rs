...
impl<'a> From<HeadEquipableIdentifier> for &HeadEquipable<'a> {
    fn from(identifier: HeadEquipableIdentifier) -> Self {
        match identifier {
...
pub enum HeadEquipableIdentifier {
